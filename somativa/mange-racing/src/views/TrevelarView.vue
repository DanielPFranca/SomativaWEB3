...
const frente = [
    { id: 1, src: 'src/assets/images/trevelar/Frente-2.png' },
    { id: 2, src: 'src/assets/images/trevelar/Frente-6.png' },
    ];

const motor = [
    { id: 1, src: 'src/assets/images/trevelar/Motor-6.png' },

];

const rodaFrente = [
    { id: 1, src: 'src/assets/images/trevelar/RodaFrente-5.png' },
    { id: 2, src: 'src/assets/images/trevelar/RodaFrente-6.png' },
];

const rodaTras = [
    { id: 1, src: 'src/assets/images/trevelar/RodaTraseira-3.jpg' },
    { id: 2, src: 'src/assets/images/trevelar/RodaTraseira-5.png' },
